...
class UnserializableField(UnserializableDataError):
    ...
    holder_class: Any = ...
    msg: Any = ...
    def __init__(self, field_name: Any, field_type: Any, holder_class: Any, msg: Optional[Any] = ...) -> None: ...
    @property
    def field_type_name(self): ...
    @property
    def holder_class_name(self): ...
...
class InvalidFieldValue(ValueError):
    ...
    holder_class: Any = ...
    msg: Any = ...
    def __init__(self, field_name: Any, field_type: Any, field_value: Any, holder_class: Any, msg: Optional[Any] = ...) -> None: ...
    @property
    def field_type_name(self): ...
    @property
    def holder_class_name(self): ...
