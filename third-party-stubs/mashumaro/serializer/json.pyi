...
class DataClassJSONMixin(DataClassDictMixin):
    def to_json(self, encoder: Encoder=..., dict_params: Mapping=..., **encoder_kwargs: Any) -> EncodedData: ...
    @classmethod
    def from_json(cls: Type[T], data: EncodedData, decoder: Decoder=..., dict_params: Mapping=..., **decoder_kwargs: Any) -> DataClassDictMixin: ...
