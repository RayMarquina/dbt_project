...
- Added support for setting policy tags for columns in BigQuery ([#2586](https://github.com/fishtown-analytics/dbt/issues/2586), [#2588](https://github.com/fishtown-analytics/dbt/pull/2588))
