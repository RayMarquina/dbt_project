...
This release provides a stable API for building new adapters and reimplements dbt's adapters as "plugins" in this architecture. Additionally, a new adapter for Presto was added. Beyond adapters, this release of dbt also includes Sources which can be used to document and test source data tables.
...
- A number of adapter methods have changed in breaking ways. These methods are primary used in dbt's materializations.
...
### Features
- Add `source`s to dbt, use them to calculate source data freshness ([#814](https://github.com/fishtown-analytics/dbt/issues/814), [#1240](https://github.com/fishtown-analytics/dbt/issues/1240))
- Add support for Presto ([#1106](https://github.com/fishtown-analytics/dbt/issues/1106))
- Add `require-dbt-version` option to `dbt_project.yml` to state the supported versions of dbt for packages ([#581](https://github.com/fishtown-analytics/dbt/issues/581))
...
- Add support for Snowflake Key Pair Authentication ([#1232](https://github.com/fishtown-analytics/dbt/pull/1232))
- Support SSO Authentication for Snowflake ([#1172](https://github.com/fishtown-analytics/dbt/issues/1172))
- Add support for Snowflake's transient tables ([#946](https://github.com/fishtown-analytics/dbt/issues/946))
- Add a new model selector (`@`) which build models, their children, and their children's parents ([#1156](https://github.com/fishtown-analytics/dbt/issues/1156))
...
- Add CLI flag to toggle warnings as errors ([#1243](https://github.com/fishtown-analytics/dbt/issues/1243))
- Added docs on how to build a new adapter ([#560](https://github.com/fishtown-analytics/dbt/issues/560))
...
Contributors:
- https://github.com/fishtown-analytics/dbt/issues/1193
- https://github.com/fishtown-analytics/dbt/pull/1191
- https://github.com/fishtown-analytics/dbt/pull/1232
