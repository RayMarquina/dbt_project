...
class DocumentationParserTest(unittest.TestCase):
    ...
    def test_load(self, system):
        ...
        results = docs.DocumentationParser.load('some_package', '/test_root',
                                               ['test_subdir'])
    ...
    def test_parse_file(self):
        unparsed = UnparsedDocumentation(
            name='test_file',
            root_path='/test_root',
        ...
        parsed = list(docs.DocumentationParser.parse_file(
            all_projects, self.root_project_config, unparsed
        ))
        ...
        self.assertEqual(table.unique_id,
                         'documentation.some_package.snowplow_sessions')

        self.assertEqual(column.name, 'snowplow_sessions__session_id')
        self.assertEqual(column.unique_id,
                         'documentation.some_package.snowplow_sessions__session_id')
