...
class BaseParserTest(unittest.TestCase):
    ...
    def file_block_for(self, data: str, filename: str, searched: str):
        root_dir = os.path.abspath('./dbt_modules/snowplow')
        path = FilePath(
...
class SchemaParserSourceTest(SchemaParserTest):
    ...
    def test__parse_basic_source(self):
        ...
        expected = ParsedSourceDefinition(
            ...
            root_path=os.path.abspath('./dbt_modules/snowplow'),
            path='models/test_one.yml',
...
class ModelParserTest(BaseParserTest):
    ...
    def test_basic(self):
        ...
        expected = ParsedModelNode(
            ...
            package_name='snowplow',
            original_file_path='models/nested/model_1.sql',
            root_path=os.path.abspath('./dbt_modules/snowplow'),
            config=NodeConfig(materialized='table'),
            path='nested/model_1.sql',
            raw_sql=raw_sql,
        )
...
class SnapshotParserTest(BaseParserTest):
    ...
    def test_single_block(self):
        ...
        expected = ParsedSnapshotNode(
            ...
            package_name='snowplow',
            original_file_path='snapshots/nested/snap_1.sql',
            root_path=os.path.abspath('./dbt_modules/snowplow'),
...
class MacroParserTest(BaseParserTest):
    ...
    def test_single_block(self):
        ...
        expected = ParsedMacro(
            ...
            package_name='snowplow',
            original_file_path='macros/macro.sql',
            root_path=os.path.abspath('./dbt_modules/snowplow'),
            path='macros/macro.sql',
            raw_sql=raw_sql
        )
...
class AnalysisParserTest(BaseParserTest):
    ...
    def test_basic(self):
        ...
        expected = ParsedAnalysisNode(
            ...
            package_name='snowplow',
            original_file_path='analyses/nested/analysis_1.sql',
            root_path=os.path.abspath('./dbt_modules/snowplow'),
            depends_on=DependsOn(),
            config=NodeConfig(),
            path='analysis/nested/analysis_1.sql',
            raw_sql=raw_sql,
        )
        self.assertEqual(node, expected)
