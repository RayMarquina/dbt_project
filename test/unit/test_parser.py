...
class SchemaParserModelsTest(SchemaParserTest):
    ...
    def test__parse_basic_model_tests(self):
        ...
        self.assertEqual(tests[0].fqn, ['snowplow', 'schema_test', tests[0].name])
        self.assertEqual(tests[0].unique_id.split('.'), ['test', 'snowplow', tests[0].name, 'fe3f9c5376'])
        ...
        self.assertEqual(tests[1].unique_id.split('.'), ['test', 'snowplow', tests[1].name, '4f5bdeb105'])
        ...
        self.assertEqual(tests[2].unique_id.split('.'), ['test', 'snowplow', tests[2].name, '651854c872'])
