    ...
    def expected_postgres_references_manifest(self, model_database=None):
        ...
        return {
            ...
            'files': {
                ...
                'ref_models/ephemeral_summary.sql': {
